/*
 * NovexOS - font.c
 * Classic 8×16 VGA bitmap font (CP437 subset: ASCII 32–127).
...
static const uint8_t font_data[96][16] = {
    ...
    {0x00, 0x00, 0xC6, 0xC6, 0x6C, 0x7C, 0x38, 0x38, 0x7C, 0x6C, 0xC6, 0xC6,
     0x00, 0x00, 0x00, 0x00},
    /* 89: 'Y' */
    {0x00, 0x00, 0xC6, 0xC6, 0xC6, 0x6C, 0x38, 0x18, 0x18, 0x18, 0x18, 0x3C,
     0x00, 0x00, 0x00, 0x00},
    /* 90: 'Z' */
...
const uint8_t *font_get_glyph(char c) {
  ...
  if (idx < 32 || idx > 127)
    idx = 32; /* Return space for out-of-range */
  return font_data[idx - 32];
}
